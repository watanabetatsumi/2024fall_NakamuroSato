...
lualatex -synctex=1 -interaction=nonstopmode -output-directory=./pdf/ ./lm_result1-3.tex
...
lualatex -synctex=1 -interaction=nonstopmode -output-directory=./pdf/ ./lm_result3-3.tex
lualatex -synctex=1 -interaction=nonstopmode -output-directory=./pdf/ ./lm_result3-4.tex
lualatex -synctex=1 -interaction=nonstopmode -output-directory=./pdf/ ./lm_result3-5.tex
...
lualatex -synctex=1 -interaction=nonstopmode -output-directory=./pdf/ ./lm_result7-1.tex
lualatex -synctex=1 -interaction=nonstopmode -output-directory=./pdf/ ./lm_result7-2.tex
lualatex -synctex=1 -interaction=nonstopmode -output-directory=./pdf/ ./lm_result7-3.tex
lualatex -synctex=1 -interaction=nonstopmode -output-directory=./pdf/ ./lm_result7-4.tex
